"""
Helpstral distress detection dataset generator.
...
SYSTEM_PROMPT = (
    "You are Helpstral, a safety AI watching over a person walking alone at night. "
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", default="helpstral_dataset.jsonl", help="Output JSONL file")
