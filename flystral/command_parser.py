...
def parse_to_waypoint_update(command: str, param: str, current_wp: dict) -> dict:
    """
    Given a Flystral command and current waypoint, return a modified waypoint dict.
...
def apply_command(event: dict, current_wp: dict) -> dict:
    """Convenience wrapper: apply a Flystral API response to the current waypoint."""
